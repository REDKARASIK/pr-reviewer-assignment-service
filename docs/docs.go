...
const docTemplate = `{
        ...
        "/stats/users": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Лимит выборки (по умолчанию 50, максимум 100)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/statistics.UserStatsResponse"
                        }
                    },
                    "500": {
    ...
    "definitions": {
        ...
        "statistics.UserStatItemResponse": {
            "type": "object",
            "properties": {
                "assignments_count": {
                    "type": "integer"
        ...
        "statistics.UserStatsResponse": {
            ...
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/statistics.UserStatItemResponse"
                    }
                },
                "limit": {
                    "type": "integer"
